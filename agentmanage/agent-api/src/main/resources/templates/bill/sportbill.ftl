            ...
            <div class="row" id="searchForm">
                <div class="col-xs-2">
                    <div class="input-group">
                        <span class="input-group-addon">${I18n.cus_bill_name}</span>
                ...
                <div class="col-xs-2">
                    <div class="input-group">
                        <span class="input-group-addon">${I18n.bill_game_type}</span>
                        <select class="form-control" id="gType" name="gType">
                            <option value="">全部</option>
                            <#list ballTypes as ballType>
                                <option value="${ballType.value}">${ballType.name}</option>
                            </#list>
                        </select>
                    </div>
                </div>
                <div class="col-xs-2">
                    <div class="input-group">
                        <span class="input-group-addon">${I18n.bill_play_type}</span>
                        <select class="form-control" name="pType">
                            <option value="">全部</option>
                            <#list playTypes as playType>
                                <option value="${playType.value}">${playType.name}</option>
                            </#list>
                        </select>
                    </div>
                </div>
                <div class="col-xs-2">
                    <div class="input-group">
                        <span class="input-group-addon">${I18n.bill_settlement}</span>
                        ...
                        <div class="box-body">
                            <table id="sport_list" class="table table-bordered table-striped" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th>${I18n.bill_mLeague_name}</th>
                                    <th>${I18n.bill_team_vs}</th>
                                    <th>${I18n.bill_play_type}</th>
                                    <th>${I18n.bill_order_val}</th>
