$(function () {
    ...
    var enumTable = $("#enum_level").dataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: base_url + "/dict/enumTypeList",
            type: "post",
            data: function (d) {
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    return function () {
                        tableData['key' + row.code] = row;
                        var html = '<p id="' + row.code + '" >' +
    ...
    var addModalValidate = $("#addModal .form").validate({
        ...
        messages: {
            name: {
                required: I18n.system_please_input + I18n.enum_type_name
            },
            code: {
                required: I18n.system_please_input + I18n.enum_type_code
            }
        },
        ...
        submitHandler: function (form) {
            ...
            $.post(base_url + "/dict/addType", param, function (data, status) {
                if (data.result === 0) {
                    $('#addModal').modal('hide');
                    layer.open({
    ...
    $("#enum_level").on('click', '.update', function () {
        ...
        var code = $(this).parent('p').attr("id");
        var row = tableData['key' + code];
    ...
    var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler: function (form) {
            ...
            $.post(base_url + "/dict/updateType", param, function (data, status) {
                if (data.result === 0) {
