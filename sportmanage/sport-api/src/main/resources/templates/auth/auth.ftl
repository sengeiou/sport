			...
			<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					<div class="form-group">
						<label for="authNameCN" class="col-sm-2 control-label">${I18n.auth_name_cn}<font color="red">*</font></label>
						<div class="col-sm-4"><input type="text" class="form-control" name="authNameCN" placeholder="${I18n.auth_name_cn}"></div>
						<label for="authNameEN" class="col-sm-2 control-label">${I18n.auth_name_en}<font color="red">*</font></label>
						<div class="col-sm-4"><input type="text" class="form-control" name="authNameEN" placeholder="${I18n.auth_name_en}" ></div>
					</div>
					<div class="form-group">
						...
						<label for="authDesc" class="col-sm-2 control-label">${I18n.auth_desc}<font color="black">*</font></label>
						<div class="col-sm-4"><input type="text" class="form-control" name="authDesc" placeholder="${I18n.auth_desc}"></div>
					</div>
					<div class="form-group">
						<label for="parent" class="col-sm-2 control-label">${I18n.auth_parent}<font color="black">*</font></label>
						<div class="col-sm-4">
						...
						<div class="col-sm-4"><input type="text" class="form-control" name="authUrl" placeholder="${I18n.auth_url}"></div>
					</div>
