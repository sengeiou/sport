			...
			<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					<div class="form-group">
						<label for="roleNameCN" class="col-sm-2 control-label">${I18n.role_name_cn}<font color="red">*</font></label>
						<div class="col-sm-4"><input type="text" class="form-control" name="roleNameCN" placeholder="${I18n.auth_name_cn}"></div>
						<label for="roleNameEN" class="col-sm-2 control-label">${I18n.role_name_en}<font color="red">*</font></label>
						<div class="col-sm-4"><input type="text" class="form-control" name="roleNameEN" placeholder="${I18n.auth_name_en}" ></div>
					</div>
					<div class="form-group">
						<label for="roleDesc" class="col-sm-2 control-label">${I18n.role_desc}<font color="black">*</font></label>
						<div class="col-sm-4"><input type="text" class="form-control" name="roleDesc" placeholder="${I18n.auth_desc}"></div>
					</div>
		...
		<div class="modal-content" style="margin-top: 25%;">
			...
			<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-6">
							<button type="submit" class="btn btn-primary" id="auth_config" >${I18n.system_save}</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">${I18n.system_cancel}</button>
						</div>
					</div>
