<#macro commonStyle>
    ...
    <link rel="stylesheet" href="${request.contextPath}/static/adminlte/bower_components/zTree_v3/css/zTreeStyle/zTreeStyle.css"  />
    <link rel="stylesheet" href="${request.contextPath}/static/adminlte/bower_components/bootstrap/css/bootstrap-switch.min.css" />
    <link rel="stylesheet" href="${request.contextPath}/static/adminlte/bower_components/bootstrap/css/bootstrap-select.min.css" />
    <style type="text/css">
            ...
            <div id="collapseListGroup2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading2">
                <ul class="list-group">
                    <li class="list-group-item <#if pageName == "offlinePayInPage">active</#if>">
                        <a href="${request.contextPath}/pay/offlinePayInPage"><span>${I18n.offline_income_audit}</span></a></li>
                    <li class="list-group-item <#if pageName == "bankDataPage">active</#if>">
                        <a href="${request.contextPath}/bankData/bankDataPage"><span>${I18n.offline_income_config}</span></a></li>
                    <li class="list-group-item <#if pageName == "payOutPage">active</#if>">
                        <a href="${request.contextPath}/pay/payOutPage"><span>${I18n.with_draw_audit}</span></a></li>
                    <li class="list-group-item <#if pageName == "paymentPage">active</#if>">
                        <a href="${request.contextPath}/payment/paymentPage"><span>${I18n.merchant_infor_config}</span></a></li>
                    <li class="list-group-item <#if pageName == "payLevelPage">active</#if>">
                        <a href="${request.contextPath}/payLevel/payLevelPage"><span>${I18n.pay_level}</span></a></li>
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.cash_system}</span></a></li>
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.credit_conver}</span></a></li>
                </ul>
            </div>
        </div>
        <div class="panel panel-primary leftMenu">
            ...
            <div id="collapseListGroup3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading3">
                <ul class="list-group">
                    ...
                    <li class="list-group-item <#if pageName == "enumTypePage">active</#if>">
                        <a href="${request.contextPath}/dict/enumTypePage"><span>${I18n.system_type}</span></a></li>
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.ope_log}</span></a></li>
                </ul>
            </div>
        </div>
        <div class="panel panel-primary leftMenu">
            ...
            <div id="collapseListGroup4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading4">
                <ul class="list-group">
                    <li class="list-group-item <#if pageName == "noticesPage">active</#if>">
                        <a href="${request.contextPath}/bulletin/noticesPage"><span>${I18n.message_center}</span></a></li>
                    <li class="list-group-item <#if pageName == "messagePage">active</#if>">
                        <a href="${request.contextPath}/bulletin/messagePage"><span>${I18n.mail_info}</span></a></li>
                </ul>
            </div>
        </div>
        <div class="panel panel-primary leftMenu">
            ...
            <div id="collapseListGroup5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading5">
                <ul class="list-group">
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.audit_score}</span></a></li>
                    <li class="list-group-item <#if pageName == "platformlimit">active</#if>">
                        <a href="${request.contextPath}/limit/platformPage"><span>${I18n.platform_limit}</span></a></li>
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.hedging_amount}</span></a></li>
                    <li class="list-group-item <#if pageName == "jobgroup">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.popular_events}</span></a></li>
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.blocking_events}</span></a></li>
                    <li class="list-group-item <#if pageName == "jobgroup">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.swabbing_warter}</span></a></li>
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.match_result}</span></a></li>
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.agent_domain}</span></a></li>
                    <li class="list-group-item <#if pageName == "jobgroup">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.half_time_settlement}</span></a></li>
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.site_config}</span></a></li>
                </ul>
            </div>
        </div>
        <div class="panel panel-primary leftMenu">
            ...
            <div id="collapseListGroup6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading6">
                <ul class="list-group">
                    ...
                    <li class="list-group-item <#if pageName == "joblog">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.special_offer}</span></a></li>
                    <li class="list-group-item <#if pageName == "jobgroup">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.home_rotation}</span></a></li>
                </ul>
            </div>
        </div>
            ...
            <div id="collapseListGroup7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading7">
                <ul class="list-group">
                    <li class="list-group-item <#if pageName == "userinfo">active</#if>">
                        <a href="${request.contextPath}/admin/userPage"><span>${I18n.admin_list}</span></a></li>
                    <li class="list-group-item <#if pageName == "rolePage">active</#if>">
                        <a href="${request.contextPath}/role/rolePage"><span>${I18n.ROLE_MANAGE}</span></a></li>
                    <li class="list-group-item <#if pageName == "authPage">active</#if>">
                        <a href="${request.contextPath}/auth/authPage"><span>${I18n.AUTH_MANAGE}</span></a></li>
                </ul>
            </div>
        </div>
    </div>
