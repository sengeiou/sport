    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="row" id="searchForm">
                ...
                <#if authOwenUrls?index_of("adminAdd") != -1>
                    <div class="col-xs-2">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        <label for="userName" class="col-sm-2 control-label">${I18n.ADMIN_ACCOUNT}<font
                                    color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="userName"
                                                     placeholder="${I18n.ADMIN_ACCOUNT}"></div>
                    ...
                    <div class="form-group">
                        <label for="type" class="col-sm-2 control-label">${I18n.ADMIN_TYPE}<font
                                    color="red">*</font></label>
                        <div class="col-sm-4">
                ...
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        <label for="userName" class="col-sm-2 control-label">${I18n.ADMIN_ACCOUNT}<font
                                    color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="userName"
                                                     placeholder="${I18n.ADMIN_ACCOUNT}" readonly="readonly"></div>
                        <label for="alias" class="col-sm-2 control-label">${I18n.ADMIN_REAL_NAME}<font
                                    color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="alias"
                                                     placeholder="${I18n.ADMIN_REAL_NAME}"></div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="statusSelect" class="col-sm-2 control-label">${I18n.STATUS_RESET}<font
                    ...
                    <div class="form-group" id="passwordReset">
                        ...
                        <label for="newPassword" class="col-sm-2 control-label">${I18n.ADMIN_PASSWORD_CONFIRM}<font
                                    color="red">*</font></label>
                        <div class="col-sm-4"><input type="newPassword_up" class="form-control" id="newPassword_up"
                                                     name="newPassword" placeholder="${I18n.login_password_confirm}">
                        </div>
                    </div>
